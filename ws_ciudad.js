...
document.getElementById("empire").prepend(interfaz)
var autoBuild = document.getElementById("autoBuild");
var ValorRecursos;
var dataCiudad = new Array();
//var diaPartida = parseInt(document.getElementsByClassName("#desplegable_sup > div.nots > div").innerText.split("DíA ")[1]);

var elemento = $(".f-izq.ayuda").text().trim();
var regex = /Día (\d+)/;
var resultado = elemento.match(regex);
if (resultado) {
    var diaPartida = resultado[1]; 
} else {
    console.log("Número de día no encontrado");
}
